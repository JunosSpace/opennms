...
<%
	...
	String readCommunityString = org.apache.commons.lang.StringEscapeUtils.escapeHtml(getValue(snmpInfo.getReadCommunity()));
	String writeCommunityString = org.apache.commons.lang.StringEscapeUtils.escapeHtml(getValue(snmpInfo.getWriteCommunity()));
	String securityName = org.apache.commons.lang.StringEscapeUtils.escapeHtml(getValue(snmpInfo.getSecurityName()));
	String securityLevel = getValue(snmpInfo.getSecurityLevel());
	String authPassPhrase = org.apache.commons.lang.StringEscapeUtils.escapeHtml(getValue(snmpInfo.getAuthPassPhrase()));
	String authProtocol = getValue(snmpInfo.getAuthProtocol());
	String privPassPhrase = org.apache.commons.lang.StringEscapeUtils.escapeHtml(getValue(snmpInfo.getPrivPassPhrase()));
